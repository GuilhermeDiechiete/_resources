...
def main(page: ft.Page):
    ...
    page.window_always_on_top = True # sempre visivel
    ...
    def calculate(operador, value_at):
        try:
            value = eval(value_at) # resolve as operações
            if operador == '%':
                value /= 100
            elif operador == '+-':
                value = -value 
    ...
    def select(e):
        ...
        value = e.control.content.value # pegando valor do botão
        if  value.isdigit():
